...
export class Catalog extends GroupObject {
    recentlyAdded: Ref<GroupObject>;
    watchedList: Ref<GroupObject>;
    watchList: Ref<GroupObject>;
    ...
    public listedItems: Map<string, EList> = new Map();
     ...
     * @param {EList} list - The list to set the watchable in.
     */
    public setWatchableList(watchable: WatchableObject, list: EList) {
